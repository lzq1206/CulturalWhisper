...
function classifyDynasty(rawText) {
  ...
  const keywordRules = [
    ...
    ['西晋', [/西晋/, /^晋$/, /晋代/, /晋初/, /晋末/, /晋代前期/]],
    ['东晋 与 十六国', [/东晋/, /十六国/, /东晋十六国/]],
    ['南北朝', [/南北朝/, /南朝/, /北朝/, /北魏/, /东魏/, /西魏/, /北齐/, /北周/]],
    ['隋朝', [/隋朝/, /隋代/, /隋\b/]],
    ['唐朝', [/唐朝/, /唐代/, /唐\b/]],
    ['五代十国', [/五代十国/, /五代/, /十国/]],
    ['宋', [/宋朝/, /宋代/, /北宋/, /南宋/, /宋初/, /宋末?/, /宋时期/, /^宋$/]],
    ['辽', [/辽朝/, /辽代/, /契丹/, /辽\b/]],
    ['金', [/金朝/, /金代/, /女真/, /金\b/]],
    ['元朝', [/元朝/, /元代/, /元\b/]],
    ['明朝', [/明朝/, /明代/, /明\b/]],
    ['清朝', [/清朝/, /清代/, /清\b/]],
    ['近代', [/中华民国/, /民国/, /民國/, /新中国/, /中华人民共和国/, /中华人民共和国时期/, /共和国/, /近代/]],
  ];
  ...
  const fuzzyTokenRules = [
    ...
    ['五代十国', ['五代十国', '五代', '十国']],
    ['西夏', ['西夏', '夏国', '党项', '李元昊', '拓跋思恭']],
    ['宋', ['宋朝', '宋代', '北宋', '南宋', '宋初', '宋末', '宋']],
    ['辽', ['辽朝', '辽代', '契丹', '辽']],
    ['金', ['金朝', '金代', '女真', '金']],
    ['元朝', ['元朝', '元代', '元']],
    ['明朝', ['明朝', '明代', '明']],
    ['清朝', ['清朝', '清代', '清']],
    ['近代', ['中华民国', '民国', '民國', '新中国', '中华人民共和国', '近代']],
  ];

  for (const [bucket, tokens] of fuzzyTokenRules) {
    if (tokens.some((token) => token && text.includes(token))) return bucket;
  }
...
function dynastyFromYear(year) {
  ...
  if (year <= 1227 && year >= 1038) return '西夏';
